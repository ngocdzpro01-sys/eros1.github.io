        ...
        <form className='flex bg-white rounded-xl max-w-4xl mx-md:mx-2'>
            ...
            <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                ...
                <div className='w-full mt-4'>
                    ...
                    <input id='name' type="text" placeholder= "Nhập vào đây" className='border
                ...
                <div className='w-full mt-4'>
                    ...
                    <input id='contact' type="text" placeholder= "Nhập vào đây" className='border
                    border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500
                    text-sm text-gray-500 font-light'required/>
                </div>
                {/* Address */}
                <div className='w-full mt-4'>
                    ...
                    <input id='address' type="text" placeholder= "Nhập vào đây" className='border
                    border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500
                    text-sm text-gray-500 font-light'required/>
                </div>
