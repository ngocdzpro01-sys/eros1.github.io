...
const ExclusiveOffers = () => {
  return (
    ...
    pt-20 pb-30'>
        ...
        w-full'>
            <Title align='left' title='Ưu đãi độc quyền' 
            subTitle='Tận hưởng các ưu đãi có thời hạn 
            và gói dịch vụ đặc biệt của chúng tôi để nâng tầm kỳ nghỉ của bạn 
            và tạo nên những kỷ niệm khó quên.'/>
            <button className='group flex items-center gap-2 font-bold cursor-pointer
            max-md:mt-12'>
                Xem thêm Offers
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12'>
            {exclusiveOffers.map((item)=>(
                ...
                bg-no-repeat bg-cover bg-center' style={{backgroundImage: `url(${item.
                image})`}}>
                    <p className='px-3 py-1 absolute top-4 left-4 text-xs bg-white
                    text-gray-800 font-bold rounded-full'>{item.priceOff}% OFF</p>
                    <div>
