...
// API to creat a new room for a hotel
...
export const getRooms = async (req, res)=>{
    console.log('getRooms handler invoked');
    try {
        ...
        console.log('getRooms: found', Array.isArray(rooms) ? rooms.length : 0);
